<template>
    <div>
        ...
        <form class="modal-content" @submit.prevent="signUpUser">
            <div class="container">
            <h1>Sign Up</h1>
            ...
            <input type="password" placeholder="Repeat Password" name="psw-repeat" required v-model="confirmPassword">
        ...
        methods: {
            async signUpUser(){
                ...
                try {
                   ...
                   await this.$store.dispatch('auth/signinAndsignupUser', data)
