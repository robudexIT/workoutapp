...
const store = createStore({
    ...
    state(){
        return {
            ...
            apiAddr: 'https://4cvpevlkn5.execute-api.us-west-2.amazonaws.com/dev' // aws api-gateway endpoint  act as a proxy for backend to allow sending and recieve cookie 
        }
    },
    getters:{
